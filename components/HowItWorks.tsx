...
const steps = [
  ...
  },
  {
    ...
    description:
      "Use our secure e-contract system to formalize terms, milestones, and payments — all legally binding and protected.",
  },
  {
    step: "04",
    icon: Rocket,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 leading-tight mb-4">
            ...
            <span className="text-blue-900">4 Simple Steps</span>
          </h2>
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-16 left-1/2 -translate-x-1/2 w-[calc(75%-3rem)] h-px bg-linear-to-r from-blue-200 via-orange-300 to-blue-200" />
            ...
            {steps.map(({ step, icon: Icon, title, description }, i) => (
              <div key={step} className="relative flex flex-col items-center text-center group">
                ...
                <div className="relative mb-6">
                  <div className="w-14 h-14 rounded-2xl bg-blue-900 group-hover:bg-orange-500 transition-colors duration-300 flex items-center justify-center shadow-lg shadow-blue-900/20 group-hover:shadow-orange-500/30 z-10 relative">
                    <Icon className="w-6 h-6 text-white" />
                  </div>
                  <span className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-orange-500 text-white text-xs font-bold flex items-center justify-center z-20">
                    {i + 1}
                  </span>
                </div>
        ...
        <div className="mt-16 text-center">
          <a
            href="#contact"
            className="inline-flex items-center gap-2 px-8 py-4 bg-blue-900 hover:bg-blue-800 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-blue-900/25 hover:-translate-y-0.5"
          >
